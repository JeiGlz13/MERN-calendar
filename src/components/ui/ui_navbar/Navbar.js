          ...
          <nav className="flex justify-between bg-zinc-800 text-white w-full">
            <div className="px-5 xl:px-12 py-3 flex w-full items-center justify-between">
              ...
              <div className="flex items-center space-x-5">
                <button className="px-5 py-2 rounded-xl text-base sm:text-lg md:text-xl font-medium text-white bg-indigo-500 hover:bg-indigo-600 active:bg-grey-900 focus:outline-none transition-all
                flex items-center">
